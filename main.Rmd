...
*You can find the original vignette [here](https://github.com/cran/gridsample/blob/master/vignettes/Rwanda.Rmd). The code in this adjusted vignette is intended to work with the [latest functioning version of the GridSample package ](https://github.com/e-kotov/gridsample). This code should be executed using R version [4.0.1 from a Rocker Geospatial container image](https://hub.docker.com/layers/rocker/geospatial/4.0.1/images/sha256-8282e2f8dfa487a29ce8a78cf5beca1548cc0a0b5142f2f3559d5e3a461dee16).*
...
```{r}
ggsave("psu_polygons.png", psu_plot, units = "cm", dpi = 160, width = 12, height = 10)
```
